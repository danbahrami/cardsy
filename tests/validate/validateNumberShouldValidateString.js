...
test("card.validate.number should validate string", assert => {
    ...
    //Assert
    assert.equal(validNumberType, true, "Returns true if a valid card number is passed as a string")
    assert.equal(invalidNumberType, false, "Returns false if an invalid card number is passed as a string")
